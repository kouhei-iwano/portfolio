    ...
    <div>
        ...
        <div>
            ...
            <div class="items">
                ...
                <div class="item">
                    <img src="../assets/lang/swift.svg" alt="logo" class="item-image">
                    <h3>Swift</h3>
                </div>
            </div>
            ...
            <div class="items">
                ...
                <div class="item">
                    <img src="../assets/lang/django.svg" alt="logo" class="item-image">
                    <h3>Django</h3>
                </div>
                <div class="item">
                    <img src="../assets/lang/pytorch.svg" alt="logo" class="item-image">
                    <h3>Pytorch</h3>
                </div>
            </div>
            ...
            <div class="items">
                <div class="item">
                    <img src="../assets/lang/linux.svg" alt="logo" class="item-image">
                    <h3>Linux</h3>
                </div>
                <div class="item">
                ...
                <div class="item">
                    <img src="../assets/lang/netlify.svg" alt="logo" class="item-image">
                    <h3>Netlify</h3>
                </div>
            </div>
        </div>
